...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
    ...
    KC_LCTL, KC_GRV,  KC_LGUI, KC_CAPS, KC_LALT,          KC_SPC,  MO(1),   MO(2),   KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  KEYMAP(
    ...
    KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, BL_ON,   BL_BRTG, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          RESET,   KC_TRNS, KC_TRNS, BL_DEC,  BL_OFF,  BL_INC)
